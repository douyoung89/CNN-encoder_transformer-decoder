...
#     device = torch.device("cpu")
    ...
    dataset_name = "cleaned_3mth" # "ct_dma"  

    if dataset_name == "cleaned_3mth": #==============================
    ...
    # Data flags
    #===================================================
    datadir =  f"../data/{dataset_name}/" # "../test/cleaned_test_3mth.pkl"
    trainset_name =  f"{dataset_name}_train.pkl" # "../test/cleaned_test_3mth.pkl"
    validset_name =  f"{dataset_name}_valid.pkl"
    testset_name =  f"{dataset_name}_test.pkl"
    density_map_path = f"{dataset_name}_density_map.pkl"
